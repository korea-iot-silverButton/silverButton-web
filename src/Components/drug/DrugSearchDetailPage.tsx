      ...
      <div css={s.conttSt}>
        ...
        <div css={s.infoBox}>
          <div css={s.detailInfo}>
            <h1>약품 효능</h1>이 약은 식욕감퇴(식욕부진), 위부팽만감, 소화불량,
            과식, 체함, 구역, 구토에 사용합니다
          </div>
          <div css={s.detailInfo}>
            <h1>약품 사용방법</h1>만 15세 이상 및 성인은 1회 1병(75 mL), 만
          ...
          <div css={s.detailInfo}>
            <h1>약품 복용 시 주의사항</h1>만 3개월 미만의 젖먹이는 이 약을
          ...
          <div css={s.detailInfo}>
            <h1>약품 부작용</h1>구역, 구토, 설사, 묽은 변 등이 나타나는 경우
            복용을 즉각 중지하고 의사 또는 약사와 상의하십시오
          </div>
          <div css={s.detailInfo}>
            <h1>약품 보관방법</h1>습기와 빛을 피해 실온에서 보관하십시오
          </div>
          <div css={s.detailInfo}>
            <h1>약품 상호작용</h1>레보도파와 함께 복용하지 마십시오
          </div>
        </div>
      </div>
    </div>
